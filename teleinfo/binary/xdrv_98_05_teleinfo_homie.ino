/*
  xdrv_98_05_teleinfo_homie.ino - Homie auto-discovery integration for Teleinfo
...
bool XdrvTeleinfoHomie (const uint32_t function)
{
  bool result = false;
  ...
  {
    case FUNC_COMMAND:
      result = DecodeCommand (kTeleinfoHomieCommands, TeleinfoHomieCommand);
      break;
