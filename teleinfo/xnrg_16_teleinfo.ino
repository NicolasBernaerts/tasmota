...
int TeleinfoGetMode ()
{
  ...
  actual_mode = (int) (Settings.sbaudrate * 1200);
...
void TeleinfoSetMode (int new_mode)
{
  uint8_t new_speed;
  
  // if within range, set baud rate
  if ((new_mode == 0) || (new_mode == 1200) || (new_mode == 9600)) Settings.sbaudrate = (uint8_t) (new_mode / 1200);
}
