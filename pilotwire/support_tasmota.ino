...
#ifdef USE_PILOTWIRE
// if toggle command, it is handled by Pilotwire
if (state == POWER_TOGGLE ) PilotwireHandleCommand (state);

// if timer command, it is handled by Pilotwire
else if (source == SRC_TIMER) PilotwireHandleCommand (state);	
