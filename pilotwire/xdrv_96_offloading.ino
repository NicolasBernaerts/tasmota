...
String OffloadingGetMqttPowerTopic ()
{
  int    index;
  String str_topic, str_setting;
...
String OffloadingGetMqttPowerKey ()
{
  int    index;
  String str_key, str_setting;
...
void OffloadingShowJSON (bool append)
{
  ...
  str_topic      = OffloadingGetMqttPowerTopic ();
  str_key        = OffloadingGetMqttPowerKey ();
...
bool OffloadingMqttData ()
{
  ...
  str_power_key     = OffloadingGetMqttPowerKey ();
  str_power_topic   = OffloadingGetMqttPowerTopic ();
