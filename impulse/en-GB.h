...
// xsns_97_remoteswitch.ino
#define D_REMOTESWITCH_PARAMETERS  "Remote Switch Parameters"
#define D_REMOTESWITCH_CONFIGURE   "Configure Remote Switch"
#define D_REMOTESWITCH_DURATION    "Switch on duration (sec)"
#define D_REMOTESWITCH_DEBOUNCE    "Anti-bounce (sec)"
#define D_REMOTESWITCH_BUTTON      "Push button"
#define D_REMOTESWITCH_MOTION      "Motion detector"
#define D_REMOTESWITCH_ENABLE      "Enable"
#define D_REMOTESWITCH_ON          "On"
#define D_REMOTESWITCH_OFF         "Off"
#define D_REMOTESWITCH_TIME_ON     "Time switched (sec)"
#define D_REMOTESWITCH_TIME_REMAIN "Time remaining (sec)"
#define D_REMOTESWITCH_FROM        "Disable from"
#define D_REMOTESWITCH_UNTIL       "until"
