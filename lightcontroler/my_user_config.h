...
#define MODULE                 SONOFF_POW_R2     // [Module] Select default model from sonoff_template.h
...
/*********************************************************************************************\
 * Light button and detector firmware configuration
\*********************************************************************************************/

#define USE_LIGHTCTRL                         // Add support for Button and motion detector light controler (+??k code)
...
#undef D_AUTHOR
#define D_AUTHOR           "Theo Arends<br />Light Controler release v1.1 by Nicolas Bernaerts"
