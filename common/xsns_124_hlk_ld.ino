/*
  xsns_124_hlkld.ino - Movement sensor HLK-LD11xx
...
void CmndHLKLDHelp ()
{
  ...
  // help on command
  AddLog (LOG_LEVEL_INFO, PSTR ("HLP: ld_conf = get last configuration from sensor"));
  AddLog (LOG_LEVEL_INFO, PSTR ("HLP: ld_def  = set all default parameters to sensor"));
  AddLog (LOG_LEVEL_INFO, PSTR ("HLP: ld_cmnd = send command to sensor"));
