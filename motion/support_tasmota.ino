...
#ifdef USE_MOTION
// handle timer calls
if (source == SRC_TIMER) MotionEnable (state);

// else handle toggle command
else if (state == POWER_TOGGLE) MotionToggleSwitch ();

// if command doesn't come from motion module, ignore it
