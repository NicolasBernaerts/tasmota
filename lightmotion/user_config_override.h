/*
  ...
  Copyright (C) 2020  Theo Arends, Nicolas Bernaerts
    ...
    25/08/2022 - v2.3 - Tasmota 12 and ESP32 compatibility
...
#define USE_LIGHT_MOTION                      // Add support for corridor light movement detection
...
#define EXTENSION_NAME "Light & Motion"       // name
...
#define MQTT_PASS          ""
#undef MQTT_TOPIC
#define MQTT_TOPIC         "lightmotion"
#undef MQTT_FULLTOPIC
#define MQTT_FULLTOPIC     "%topic%/%prefix%/"
#undef FRIENDLY_NAME
#define FRIENDLY_NAME      "Light & Motion"
...
#define SUNRISE_DAWN_ANGLE DAWN_NORMAL       // Select desired Dawn Angle from
